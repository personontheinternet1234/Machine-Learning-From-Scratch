...
output_index = ["FNN_checkered", "non-FNN_checkered"]
...
# file locations
input_data_location = "processed_data/input_data.txt"
output_data_location = "processed_data/output_data.txt"
...
# input_training = []
# output_training = []
# with open("processed_data/input_data.txt", "r") as f:
#     for line in f:
#         input_training.append(ast.literal_eval(line))
# with open("processed_data/output_data.txt", "r") as f:
#     for line in f:
...
# format training processed_data
